...
// ... existing code ...
// Removed redundant commented imports
//import './blogread.css'
...
const BlogDetails = () => {
    ...
    useEffect(()=>{
        axios.get('https://ezemmuoblockchain-5.onrender.com/admin_dashboard/users')
        .then(response => {
    ...
    function submitComment(e){
        e.preventDefault()
        axios.post(`https://ezemmuoblockchain-5.onrender.com/blogs/${blogId.id}/comments`, commenInfo)
        .then(res=>{
            console.log(res)
        })
        .catch(err=>{
