...
console.log(base64)
    ...
    function handleSubmit(e) {
        ...
        axios.post('https://ezemmuoblockchain-5.onrender.com/api/blogs', body)
            .then(response => {
    ...
    return (
        ...
        <div className='blogForm'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <strong> <Link to={`/blog/${formData.title.split('').join('-')}`}>{isBlog}</Link> </strong>
                <strong>{isError}</strong>
                <div className='blog-form-button'>
               <button type='submit' disabled ={ sub ? false : true} >{sub ? 'Create' : 'Loading...'}</button>
