...
const BlogDetails = () => {
    ...
    useEffect(()=>{
        axios.get('https://ezemmuoblockchain-4.onrender.com/admin_dashboard/users')
        .then(response => {
    ...
    function submitComment(e){
        e.preventDefault()
        axios.post(`https://ezemmuoblockchain-4.onrender.com/blogs/${blogId.id}/comments`, commenInfo)
        .then(res=>{
            console.log(res)
        })
        .catch(err=>{
